...
public class SeckillOrderAddConsumer implements RocketMQListener<MessageExt> {
    private static final String MESSAGE_LOCK_ORDER_ADD_PREFIX="message:lock:order:seckill:add:";
    @Autowired
    ...
    public void onMessage(MessageExt message) {
        ...
        SeckillOrderAddDTO orderAddDTO =null;
        try{
            orderAddDTO = JSON.toJavaObject(JSON.parseObject(orderJson), SeckillOrderAddDTO.class);
